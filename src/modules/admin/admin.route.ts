...
router.get('/transaction-activity', checkAuth(Role.ADMIN), AdminControllers.transactionActivity);
...
router.delete("/delete-idea/:id", checkAuth(Role.ADMIN), AdminControllers.deleteIdea);
